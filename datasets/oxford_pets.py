    ...
    def __init__(self, cfg):
        ...
        if cfg.TRAINER.NAME == "PromptKD":
            if cfg.TRAINER.MODAL == "base2novel":
                ...
                # if cfg.TRAINER.PROMPTKD.CLIENT_DATA_POLLUTION is True:
                #     print("Enable data pollution")
                #     train_x = data_pollution(train_x, cfg.TRAINER.PROMPTKD.POLLUTION_PERCENTAGE)
                #     # train_x = data_pollution(train_x, cfg.TRAINER.PROMPTKD.POLLUTION_PERCENTAGE,
