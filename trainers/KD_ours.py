...
class KD_ours(Distiller):
    ...
    def forward_train(self, image_weak, target, **kwargs):
        with torch.no_grad():
        ...
        # print(self.kd_loss_weight)
        # print(self.bt_loss_weight)
        # losses
...
# CUDA_VISIBLE_DEVICES=1 bash scripts/federated-promptkd/fed_train_only.sh oxford_pets 1
# CUDA_VISIBLE_DEVICES=1 bash scripts/federated-promptkd/fed_train_only.sh tinyimagenet200 3
