...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        # self.SECOND_PHASE = cfg.TRAINER.PROMPTKD.SECOND_PHASE
        # self.second_max_epoch = cfg.TRAINER.PROMPTKD.SECOND_ROUND
    ...
    def train(self):
        ...
        #     super().train(self.start_epoch, self.second_max_epoch)
        # else:
